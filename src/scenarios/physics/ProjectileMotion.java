...
public class ProjectileMotion extends Scenario {
    ...
    private static void printQuestion() {
        switch (problemType) {
            case INIT_THETA:
                System.out.println("What is the initial theta?");
                break;
            case INIT_VH:
                System.out.println("What is the initial velocity?");
                break;
            case INIT_VX:
                System.out.println("What is the initial velocity of the X position?");
                break;
            case INIT_VY:
                System.out.println("What is the initial velocity of the Y position?");
                break;
            case F_THETA:

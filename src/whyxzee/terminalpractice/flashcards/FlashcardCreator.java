...
/**
 * UI menu for creating flashcards
 */
public class FlashcardCreator extends JPanel implements ActionListener {
    FlashcardCreatorDaemon daemon;
    ...
    public FlashcardCreator() throws InterruptedException {
    ...
    public void display() {
        ...
        daemon = new FlashcardCreatorDaemon(this);
 ...
 */
class FlashcardCreatorDaemon extends Thread {
    private FlashcardCreator ui;

    public FlashcardCreatorDaemon(FlashcardCreator ui) {
